...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_game_start(self, config):
        ...
        self.secondary_turrets = [[16,11], [17,10], [13,2], [14,13], [15,12] ]
        ...
        self.blocking_turret_position = [20,7]
        ...
        if mp >= 15 and self.turret_removed_for_attack:  # Higher threshold for actual attack
            ...
            if actual_wave1 > 0:
                ...
                gamelib.debug_write('SCOUT RUSH: Failed to deploy wave 1 at {} (MP: {})'.format(
                    self.scout_attack_position1, mp))

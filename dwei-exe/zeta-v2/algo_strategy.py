...
2. Replace turrets at [0,13] and [27,13] with upgraded walls (only replace walls below 25% health)
3. Strategic upgrade priority: [24,13], [24,12], [1,12], [2,13], [19,11], [16,11], [9,12]
4. 3-Phase Attack System (MINIMUM 20 scouts, ALWAYS rebuilds defenses):
   - Phase 1: ADD funnel turret at [22,11], REMOVE turrets at blocking_turret_position2 (MP >= 20, SP >= 1)
   - Phase 2: Deploy 3 scouts at [13,0] + remaining scouts at [11,2] AND remove funnel turret [22,11] (same turn)
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def upgrade_structures(self, game_state):
        ...
        if self.primary_turrets_complete(game_state) and sp >= 10:

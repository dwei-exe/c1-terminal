...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_game_start(self, config):
        ...
        # Primary turret defense positions (removed [0,13] and [27,13])
        self.primary_turrets = [
            [1,12],[1,13],[2,12],[2,13],[3,13],[4,13],[5,13],[6,12],[6,13],[7,12],[8,12],[9,12],[10,12],[11,12],[12,12],[13,12],[14,12],[15,12],[16,12],[17,12],[18,12],[19,12],[20,12],[21,12],[21,13],[22,12],[22,13],[23,13],[24,12],[24,13],[25,12],[25,13],[26,12],[26,13]
        ]
        
        # Secondary turret positions (build after primary complete)
        self.secondary_turrets = [[3,12],[4,12],[5,12],[23,12],[4,11],[5,11],[6,11],[21,11],[22,11],[23,11],[24,11],[25,11]]
    ...
    def upgrade_structures(self, game_state):
        ...
        if self.all_turrets_complete(game_state):
            ...
            # Get all our structures (excluding corner walls as they're handled separately)
